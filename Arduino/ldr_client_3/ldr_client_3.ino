...
#define COAP_PORT 5685
#define MQTT_PORT 1883
#define MQTT_USER "lorenzo"
#define MQTT_PASSWORD "11235813"

#define SAMPLING_PERIOD_TOPIC "home/ldr3/sampling_period"
#define POSITION_TOPIC "home/ldr3/position"
...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect("LDR3", MQTT_USER, MQTT_PASSWORD)) {
